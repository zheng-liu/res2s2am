# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_1000_fold_1337.p' --train_kwargs='train_kwargs_DeFine_1000_fold_1337.p' --trainset='trainset_snp_1000_fold_1337.txt' --valset='valset_snp_1000_fold_1337.txt' --sampling='snp' --output='out_train_DeFine_1000_fold_1337.txt' --log='log_train_DeFine_1000_fold_1337.txt' --model='model_DeFine_1000_fold_1337.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_1000_fold_1338.p' --train_kwargs='train_kwargs_DeFine_1000_fold_1338.p' --trainset='trainset_snp_1000_fold_1338.txt' --valset='valset_snp_1000_fold_1338.txt' --sampling='snp' --output='out_train_DeFine_1000_fold_1338.txt' --log='log_train_DeFine_1000_fold_1338.txt' --model='model_DeFine_1000_fold_1338.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_1000_fold_1339.p' --train_kwargs='train_kwargs_DeFine_1000_fold_1339.p' --trainset='trainset_snp_1000_fold_1339.txt' --valset='valset_snp_1000_fold_1339.txt' --sampling='snp' --output='out_train_DeFine_1000_fold_1339.txt' --log='log_train_DeFine_1000_fold_1339.txt' --model='model_DeFine_1000_fold_1339.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_1000_fold_1340.p' --train_kwargs='train_kwargs_DeFine_1000_fold_1340.p' --trainset='trainset_snp_1000_fold_1340.txt' --valset='valset_snp_1000_fold_1340.txt' --sampling='snp' --output='out_train_DeFine_1000_fold_1340.txt' --log='log_train_DeFine_1000_fold_1340.txt' --model='model_DeFine_1000_fold_1340.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_1000_fold_1341.p' --train_kwargs='train_kwargs_DeFine_1000_fold_1341.p' --trainset='trainset_snp_1000_fold_1341.txt' --valset='valset_snp_1000_fold_1341.txt' --sampling='snp' --output='out_train_DeFine_1000_fold_1341.txt' --log='log_train_DeFine_1000_fold_1341.txt' --model='model_DeFine_1000_fold_1341.pt'

# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_locus_1000_fold_1337.p' --train_kwargs='train_kwargs_DeFine_locus_1000_fold_1337.p' --trainset='trainset_locus_1000_fold_1337.txt' --valset='valset_locus_1000_fold_1337.txt' --sampling='locus' --output='out_train_DeFine_locus_1000_fold_1337.txt' --log='log_train_DeFine_locus_1000_fold_1337.txt' --model='model_DeFine_locus_1000_fold_1337.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_locus_1000_fold_1338.p' --train_kwargs='train_kwargs_DeFine_locus_1000_fold_1338.p' --trainset='trainset_locus_1000_fold_1338.txt' --valset='valset_locus_1000_fold_1338.txt' --sampling='locus' --output='out_train_DeFine_locus_1000_fold_1338.txt' --log='log_train_DeFine_locus_1000_fold_1338.txt' --model='model_DeFine_locus_1000_fold_1338.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_locus_1000_fold_1339.p' --train_kwargs='train_kwargs_DeFine_locus_1000_fold_1339.p' --trainset='trainset_locus_1000_fold_1339.txt' --valset='valset_locus_1000_fold_1339.txt' --sampling='locus' --output='out_train_DeFine_locus_1000_fold_1339.txt' --log='log_train_DeFine_locus_1000_fold_1339.txt' --model='model_DeFine_locus_1000_fold_1339.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_locus_1000_fold_1340.p' --train_kwargs='train_kwargs_DeFine_locus_1000_fold_1340.p' --trainset='trainset_locus_1000_fold_1340.txt' --valset='valset_locus_1000_fold_1340.txt' --sampling='locus' --output='out_train_DeFine_locus_1000_fold_1340.txt' --log='log_train_DeFine_locus_1000_fold_1340.txt' --model='model_DeFine_locus_1000_fold_1340.pt'
# python3 train_DeFine.py --device=? --model_kwargs='model_kwargs_DeFine_locus_1000_fold_1341.p' --train_kwargs='train_kwargs_DeFine_locus_1000_fold_1341.p' --trainset='trainset_locus_1000_fold_1341.txt' --valset='valset_locus_1000_fold_1341.txt' --sampling='locus' --output='out_train_DeFine_locus_1000_fold_1341.txt' --log='log_train_DeFine_locus_1000_fold_1341.txt' --model='model_DeFine_locus_1000_fold_1341.pt'
...
if __name__ == '__main__':
    ...
    if gpu:
        model = DeFine.DeFine(model_kwargs).cuda()
        #model = torch.nn.DataParallel(model)
        class_imbalance = torch.FloatTensor(imbalance).cuda()
    else:
        model = DeFine.DeFine(model_kwargs)

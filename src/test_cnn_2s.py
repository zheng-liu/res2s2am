# python3 test_cnn_2s.py --device=? --test_kwargs='test_kwargs_cnn_2s_1000_fold_1337.p' --testset='testset_snp_1000_fold_1337.txt' --sampling='snp' --model='model_cnn_2s_1000_fold_1337.pt' --output='out_test_cnn_2s_1000_fold_1337.txt' --roc='roc_test_cnn_2s_1000_fold_1337.txt' --prc='prc_test_cnn_2s_1000_fold_1337.txt'
# python3 test_cnn_2s.py --device=? --test_kwargs='test_kwargs_cnn_2s_1000_fold_1338.p' --testset='testset_snp_1000_fold_1338.txt' --sampling='snp' --model='model_cnn_2s_1000_fold_1338.pt' --output='out_test_cnn_2s_1000_fold_1338.txt' --roc='roc_test_cnn_2s_1000_fold_1338.txt' --prc='prc_test_cnn_2s_1000_fold_1338.txt'
# python3 test_cnn_2s.py --device=? --test_kwargs='test_kwargs_cnn_2s_1000_fold_1339.p' --testset='testset_snp_1000_fold_1339.txt' --sampling='snp' --model='model_cnn_2s_1000_fold_1339.pt' --output='out_test_cnn_2s_1000_fold_1339.txt' --roc='roc_test_cnn_2s_1000_fold_1339.txt' --prc='prc_test_cnn_2s_1000_fold_1339.txt'
# python3 test_cnn_2s.py --device=? --test_kwargs='test_kwargs_cnn_2s_1000_fold_1340.p' --testset='testset_snp_1000_fold_1340.txt' --sampling='snp' --model='model_cnn_2s_1000_fold_1340.pt' --output='out_test_cnn_2s_1000_fold_1340.txt' --roc='roc_test_cnn_2s_1000_fold_1340.txt' --prc='prc_test_cnn_2s_1000_fold_1340.txt'
# python3 test_cnn_2s.py --device=? --test_kwargs='test_kwargs_cnn_2s_1000_fold_1341.p' --testset='testset_snp_1000_fold_1341.txt' --sampling='snp' --model='model_cnn_2s_1000_fold_1341.pt' --output='out_test_cnn_2s_1000_fold_1341.txt' --roc='roc_test_cnn_2s_1000_fold_1341.txt' --prc='prc_test_cnn_2s_1000_fold_1341.txt'
...
def make_kwargs(filename_test_kwargs):
    # test_kwargs, cnn_2s
    test_kwargs_cnn_2s = {}
    test_kwargs_cnn_2s['random_seed'] = 1337
    test_kwargs_cnn_2s['cudnn'] = True
    test_kwargs_cnn_2s['batch_size'] = 256
    test_kwargs_cnn_2s['encode_mode'] = 'N_2_zero'
    test_kwargs_cnn_2s['shuffle'] = True
    test_kwargs_cnn_2s['num_workers'] = 8
    pickle.dump(test_kwargs_cnn_2s, open(filename_test_kwargs, 'wb'))
    print('[INFO] {} dumped!'.format(filename_test_kwargs))
    return test_kwargs_cnn_2s

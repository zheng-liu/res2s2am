# python3 test_DeFine0.py --device=? --test_kwargs='test_kwargs_DeFine0_1000_fold_1337.p' --testset='testset_snp_1000_fold_1337.txt' --sampling='snp' --model='model_DeFine0_1000_fold_1337.pt' --output='out_test_DeFine0_1000_fold_1337.txt' --roc='roc_test_DeFine0_1000_fold_1337.txt' --prc='prc_test_DeFine0_1000_fold_1337.txt'
# python3 test_DeFine0.py --device=? --test_kwargs='test_kwargs_DeFine0_1000_fold_1338.p' --testset='testset_snp_1000_fold_1338.txt' --sampling='snp' --model='model_DeFine0_1000_fold_1338.pt' --output='out_test_DeFine0_1000_fold_1338.txt' --roc='roc_test_DeFine0_1000_fold_1338.txt' --prc='prc_test_DeFine0_1000_fold_1338.txt'
# python3 test_DeFine0.py --device=? --test_kwargs='test_kwargs_DeFine0_1000_fold_1339.p' --testset='testset_snp_1000_fold_1339.txt' --sampling='snp' --model='model_DeFine0_1000_fold_1339.pt' --output='out_test_DeFine0_1000_fold_1339.txt' --roc='roc_test_DeFine0_1000_fold_1339.txt' --prc='prc_test_DeFine0_1000_fold_1339.txt'
# python3 test_DeFine0.py --device=? --test_kwargs='test_kwargs_DeFine0_1000_fold_1340.p' --testset='testset_snp_1000_fold_1340.txt' --sampling='snp' --model='model_DeFine0_1000_fold_1340.pt' --output='out_test_DeFine0_1000_fold_1340.txt' --roc='roc_test_DeFine0_1000_fold_1340.txt' --prc='prc_test_DeFine0_1000_fold_1340.txt'
# python3 test_DeFine0.py --device=? --test_kwargs='test_kwargs_DeFine0_1000_fold_1341.p' --testset='testset_snp_1000_fold_1341.txt' --sampling='snp' --model='model_DeFine0_1000_fold_1341.pt' --output='out_test_DeFine0_1000_fold_1341.txt' --roc='roc_test_DeFine0_1000_fold_1341.txt' --prc='prc_test_DeFine0_1000_fold_1341.txt'
...
def make_kwargs(filename_test_kwargs):
    # test_kwargs, test_DeFine0
    test_kwargs_DeFine = {}
    test_kwargs_DeFine['random_seed'] = 1337
    test_kwargs_DeFine['cudnn'] = True
    test_kwargs_DeFine['batch_size'] = 256
    test_kwargs_DeFine['encode_mode'] = 'N_2_zero'
    test_kwargs_DeFine['shuffle'] = True
    test_kwargs_DeFine['num_workers'] = 8
    pickle.dump(test_kwargs_DeFine, open(filename_test_kwargs, 'wb'))
    print('[INFO] {} dumped!'.format(filename_test_kwargs))
    return test_kwargs_DeFine
...
if __name__ == '__main__':
    ...
    model.train(False)
    testset = GenomeDataset(filename=filename_testset, seq_name=['seq_ref_1', 'seq_ref_2'], encode_mode=encode_mode)
    ...
    if sampling == 'locus':
        ...
        for rs in testset_pred[testset_pred['label']==1]['rsid']:
            ...
            print(rsids_locus['prob'])
            rsids_locus['rank'] = [len(rsids_locus)+1-r for r in rsids_locus['rank']]

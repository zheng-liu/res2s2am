# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_1000_fold_1337.p' --train_kwargs='train_kwargs_cnn_2s_1000_fold_1337.p' --trainset='trainset_snp_1000_fold_1337.txt' --valset='valset_snp_1000_fold_1337.txt' --sampling='snp' --output='out_train_cnn_2s_1000_fold_1337.txt' --log='log_train_cnn_2s_1000_fold_1337.txt' --model='model_cnn_2s_1000_fold_1337.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_1000_fold_1338.p' --train_kwargs='train_kwargs_cnn_2s_1000_fold_1338.p' --trainset='trainset_snp_1000_fold_1338.txt' --valset='valset_snp_1000_fold_1338.txt' --sampling='snp' --output='out_train_cnn_2s_1000_fold_1338.txt' --log='log_train_cnn_2s_1000_fold_1338.txt' --model='model_cnn_2s_1000_fold_1338.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_1000_fold_1339.p' --train_kwargs='train_kwargs_cnn_2s_1000_fold_1339.p' --trainset='trainset_snp_1000_fold_1339.txt' --valset='valset_snp_1000_fold_1339.txt' --sampling='snp' --output='out_train_cnn_2s_1000_fold_1339.txt' --log='log_train_cnn_2s_1000_fold_1339.txt' --model='model_cnn_2s_1000_fold_1339.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_1000_fold_1340.p' --train_kwargs='train_kwargs_cnn_2s_1000_fold_1340.p' --trainset='trainset_snp_1000_fold_1340.txt' --valset='valset_snp_1000_fold_1340.txt' --sampling='snp' --output='out_train_cnn_2s_1000_fold_1340.txt' --log='log_train_cnn_2s_1000_fold_1340.txt' --model='model_cnn_2s_1000_fold_1340.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_1000_fold_1341.p' --train_kwargs='train_kwargs_cnn_2s_1000_fold_1341.p' --trainset='trainset_snp_1000_fold_1341.txt' --valset='valset_snp_1000_fold_1341.txt' --sampling='snp' --output='out_train_cnn_2s_1000_fold_1341.txt' --log='log_train_cnn_2s_1000_fold_1341.txt' --model='model_cnn_2s_1000_fold_1341.pt'

# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_locus_1000_fold_1337.p' --train_kwargs='train_kwargs_cnn_2s_locus_1000_fold_1337.p' --trainset='trainset_locus_1000_fold_1337.txt' --valset='valset_locus_1000_fold_1337.txt' --sampling='locus' --output='out_train_cnn_2s_locus_1000_fold_1337.txt' --log='log_train_cnn_2s_locus_1000_fold_1337.txt' --model='model_cnn_2s_locus_1000_fold_1337.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_locus_1000_fold_1338.p' --train_kwargs='train_kwargs_cnn_2s_locus_1000_fold_1338.p' --trainset='trainset_locus_1000_fold_1338.txt' --valset='valset_locus_1000_fold_1338.txt' --sampling='locus' --output='out_train_cnn_2s_locus_1000_fold_1338.txt' --log='log_train_cnn_2s_locus_1000_fold_1338.txt' --model='model_cnn_2s_locus_1000_fold_1338.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_locus_1000_fold_1339.p' --train_kwargs='train_kwargs_cnn_2s_locus_1000_fold_1339.p' --trainset='trainset_locus_1000_fold_1339.txt' --valset='valset_locus_1000_fold_1339.txt' --sampling='locus' --output='out_train_cnn_2s_locus_1000_fold_1339.txt' --log='log_train_cnn_2s_locus_1000_fold_1339.txt' --model='model_cnn_2s_locus_1000_fold_1339.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_locus_1000_fold_1340.p' --train_kwargs='train_kwargs_cnn_2s_locus_1000_fold_1340.p' --trainset='trainset_locus_1000_fold_1340.txt' --valset='valset_locus_1000_fold_1340.txt' --sampling='locus' --output='out_train_cnn_2s_locus_1000_fold_1340.txt' --log='log_train_cnn_2s_locus_1000_fold_1340.txt' --model='model_cnn_2s_locus_1000_fold_1340.pt'
# python3 train_cnn_2s.py --device=? --model_kwargs='model_kwargs_cnn_2s_locus_1000_fold_1341.p' --train_kwargs='train_kwargs_cnn_2s_locus_1000_fold_1341.p' --trainset='trainset_locus_1000_fold_1341.txt' --valset='valset_locus_1000_fold_1341.txt' --sampling='locus' --output='out_train_cnn_2s_locus_1000_fold_1341.txt' --log='log_train_cnn_2s_locus_1000_fold_1341.txt' --model='model_cnn_2s_locus_1000_fold_1341.pt'
...
def make_kwargs(filename_model_kwargs, filename_train_kwargs):
    ...
    train_kwargs_cnn_2s['optim_param'] = {'betas': [0.9, 0.999], 'lr': 0.001, 'weight_decay': 1e-5}
    ...
    train_kwargs_cnn_2s['batch_size'] = 256
...
if __name__ == '__main__':
    ...
    with open(filename_output, 'w') as f:
        ...
        f.write('-'*10+'\n')
        f.write(str(args))
    print('[INFO] train_cnn_2s model training output (with settings) saved to {}'.format(filename_output))

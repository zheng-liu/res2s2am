# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_1000_fold_1337.p' --train_kwargs='train_kwargs_resnet_2s2a_1000_fold_1337.p' --trainset='trainset_snp_1000_fold_1337.txt' --valset='valset_snp_1000_fold_1337.txt' --sampling='snp' --output='out_train_resnet_2s2a_1000_fold_1337.txt' --log='log_train_resnet_2s2a_1000_fold_1337.txt' --model='model_resnet_2s2a_1000_fold_1337.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_1000_fold_1338.p' --train_kwargs='train_kwargs_resnet_2s2a_1000_fold_1338.p' --trainset='trainset_snp_1000_fold_1338.txt' --valset='valset_snp_1000_fold_1338.txt' --sampling='snp' --output='out_train_resnet_2s2a_1000_fold_1338.txt' --log='log_train_resnet_2s2a_1000_fold_1338.txt' --model='model_resnet_2s2a_1000_fold_1338.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_1000_fold_1339.p' --train_kwargs='train_kwargs_resnet_2s2a_1000_fold_1339.p' --trainset='trainset_snp_1000_fold_1339.txt' --valset='valset_snp_1000_fold_1339.txt' --sampling='snp' --output='out_train_resnet_2s2a_1000_fold_1339.txt' --log='log_train_resnet_2s2a_1000_fold_1339.txt' --model='model_resnet_2s2a_1000_fold_1339.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_1000_fold_1340.p' --train_kwargs='train_kwargs_resnet_2s2a_1000_fold_1340.p' --trainset='trainset_snp_1000_fold_1340.txt' --valset='valset_snp_1000_fold_1340.txt' --sampling='snp' --output='out_train_resnet_2s2a_1000_fold_1340.txt' --log='log_train_resnet_2s2a_1000_fold_1340.txt' --model='model_resnet_2s2a_1000_fold_1340.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_1000_fold_1341.p' --train_kwargs='train_kwargs_resnet_2s2a_1000_fold_1341.p' --trainset='trainset_snp_1000_fold_1341.txt' --valset='valset_snp_1000_fold_1341.txt' --sampling='snp' --output='out_train_resnet_2s2a_1000_fold_1341.txt' --log='log_train_resnet_2s2a_1000_fold_1341.txt' --model='model_resnet_2s2a_1000_fold_1341.pt'

# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_locus_1000_fold_1337.p' --train_kwargs='train_kwargs_resnet_2s2a_locus_1000_fold_1337.p' --trainset='trainset_locus_1000_fold_1337.txt' --valset='valset_locus_1000_fold_1337.txt' --sampling='locus' --output='out_train_resnet_2s2a_locus_1000_fold_1337.txt' --log='log_train_resnet_2s2a_locus_1000_fold_1337.txt' --model='model_resnet_2s2a_locus_1000_fold_1337.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_locus_1000_fold_1338.p' --train_kwargs='train_kwargs_resnet_2s2a_locus_1000_fold_1338.p' --trainset='trainset_locus_1000_fold_1338.txt' --valset='valset_locus_1000_fold_1338.txt' --sampling='locus' --output='out_train_resnet_2s2a_locus_1000_fold_1338.txt' --log='log_train_resnet_2s2a_locus_1000_fold_1338.txt' --model='model_resnet_2s2a_locus_1000_fold_1338.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_locus_1000_fold_1339.p' --train_kwargs='train_kwargs_resnet_2s2a_locus_1000_fold_1339.p' --trainset='trainset_locus_1000_fold_1339.txt' --valset='valset_locus_1000_fold_1339.txt' --sampling='locus' --output='out_train_resnet_2s2a_locus_1000_fold_1339.txt' --log='log_train_resnet_2s2a_locus_1000_fold_1339.txt' --model='model_resnet_2s2a_locus_1000_fold_1339.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_locus_1000_fold_1340.p' --train_kwargs='train_kwargs_resnet_2s2a_locus_1000_fold_1340.p' --trainset='trainset_locus_1000_fold_1340.txt' --valset='valset_locus_1000_fold_1340.txt' --sampling='locus' --output='out_train_resnet_2s2a_locus_1000_fold_1340.txt' --log='log_train_resnet_2s2a_locus_1000_fold_1340.txt' --model='model_resnet_2s2a_locus_1000_fold_1340.pt'
# python3 train_resnet_2s2a.py --device=? --model_kwargs='model_kwargs_resnet_2s2a_locus_1000_fold_1341.p' --train_kwargs='train_kwargs_resnet_2s2a_locus_1000_fold_1341.p' --trainset='trainset_locus_1000_fold_1341.txt' --valset='valset_locus_1000_fold_1341.txt' --sampling='locus' --output='out_train_resnet_2s2a_locus_1000_fold_1341.txt' --log='log_train_resnet_2s2a_locus_1000_fold_1341.txt' --model='model_resnet_2s2a_locus_1000_fold_1341.pt'
...
def make_kwargs(filename_model_kwargs, filename_train_kwargs):
    ...
    train_kwargs_resnet_2s2a['optim_param'] = {'betas': [0.9, 0.999], 'lr': 0.001, 'weight_decay': 1e-5}
...
if __name__ == '__main__':
    ...
    # read datasets
    trainset = GenomeDataset(filename=filename_trainset, seq_name=['seq_ref_1', 'seq_ref_2', 'seq_alt_1', 'seq_alt_2'], encode_mode=encode_mode)
    trainloader = DataLoader(trainset, batch_size=batch_size, shuffle=shuffle, num_workers=num_workers)
    valset = GenomeDataset(filename=filename_valset, seq_name=['seq_ref_1', 'seq_ref_2', 'seq_alt_1', 'seq_alt_2'], encode_mode=encode_mode)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for data in tqdm(dataloaders[phase]):
                inputs1, inputs2, inputs3, inputs4, labels, _, _ = data
                if gpu:
                    ...
                    inputs1, inputs2, inputs3, inputs4, labels = Variable(inputs1), Variable(inputs2), Variable(inputs3), Variable(inputs4), Variable(labels)
                optimizer.zero_grad()

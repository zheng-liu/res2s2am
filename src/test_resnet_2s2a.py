...
def make_kwargs(filename_test_kwargs):
    # test_kwargs, resnet_2s2a
    test_kwargs_resnet_2s2a = {}
    test_kwargs_resnet_2s2a['random_seed'] = 1337
    test_kwargs_resnet_2s2a['cudnn'] = True
    test_kwargs_resnet_2s2a['batch_size'] = 256
    test_kwargs_resnet_2s2a['encode_mode'] = 'N_2_zero'
    test_kwargs_resnet_2s2a['shuffle'] = True
    test_kwargs_resnet_2s2a['num_workers'] = 8
    pickle.dump(test_kwargs_resnet_2s2a, open(filename_test_kwargs, 'wb'))
    print('[INFO] {} dumped!'.format(filename_test_kwargs))
    return test_kwargs_resnet_2s2a
...
if __name__ == '__main__':
    ...
    model.train(False)
    testset = GenomeDataset(filename=filename_testset, seq_name=['seq_ref_1', 'seq_ref_2', 'seq_alt_1', 'seq_alt_2'], encode_mode=encode_mode)
    ...
    for data in tqdm(testloader):
        inputs1, inputs2, inputs3, inputs4, labels, rsids, query_snp_rsids = data
